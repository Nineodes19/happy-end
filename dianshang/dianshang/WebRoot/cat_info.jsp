					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li ><a href="ProductServlet">新鲜果蔬<span class="sr-only">(current)</span></a></li>
								<li class="active"><a href="CatServlet">萌宠家族</a></li>
								<li><a href="#">彩妆系列</a></li>
								<li><a href="#">精品文具</a></li>
							</ul>
			...
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">亿家价: <strong style="color:#ef0101;">￥：${p.pprice }</strong> 参 考 价： <del>￥${p.ppricezk }</del>
						</div>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<div style="margin:20px 0 10px 0;;text-align: center;">
								<a href="CatShopServlet?id=${p.pid }">
				...
				<div style="width:950px;margin:0 auto;">
					<div style="background-color:#d3d3d3;width:930px;padding:10px 10px;margin:10px 0 10px 0;">
						<strong>商品介绍</strong>
						<div>
							<p><font color="blue">${p.pdes }</font></p>
